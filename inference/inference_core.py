...
class InferenceCore:
    def __init__(self, network:XMem, config):
        ...
        """ extra value for export """
        self.export_val_enc_key = ()
        self.export_val_enc_val = ()
        self.export_val_dec     = ()
        self.export_flag = [True, True, True]
    ...
    def step(self, image, mask=None, valid_labels=None, end=False):
        ...
        if self.export_flag[0]:
            self.export_val_enc_key = (key, shrinkage, selection, f16, f8, f4)
            self.export_flag[0] = False
        ...
        if need_segment:
            ...
            """ set value for export """
            if self.export_flag[1]:
                self.export_val_dec = (memory_readout, hidden, pred_logits_with_bg, pred_prob_with_bg)
                self.export_flag[1] = False
        ...
        if is_mem_frame:
            ...
            """ set value for export """
            if self.export_flag[2]:
                self.export_val_enc_val = (value, hidden, self.all_labels)
                self.export_flag[2] = False
